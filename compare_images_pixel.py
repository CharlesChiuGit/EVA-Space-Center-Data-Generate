...
if __name__ == '__main__':
    img1 = cv2.imread('D:/EVA-Space-Center-Data-Generate/src/Single_Image_center.png')
    img2 = cv2.imread('D:/EVA-Space-Center-Data-Generate/src/Single_Image_infinite_far.png')
